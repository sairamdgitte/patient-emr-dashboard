...
// Webhook URLs
export const WH_IC = "https://hooks.au.webexconnect.io/events/DRZFTVMQXP";
...
export const PAT_PHONE = "mondo.k@rmit.edu.au";
export const HOST_PHONE = "marcus.lim3@rmit.edu.au";
